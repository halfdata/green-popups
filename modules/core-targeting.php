...
<div class="lepopup-dialog" id="lepopup-dialog">
	...
	function the_content($_content) {
		...
		if (array_key_exists('inlinepostend', $this->content_targets) && !empty($this->content_targets['inlinepostend']) && class_exists('lepopup_front_class')) {
			...
			if ($this->content_targets['inlinepostend']['item_mobile'] != 'same' && (!empty($this->content_targets['inlinepostend']['item']) || !empty($this->content_targets['inlinepostend']['item_mobile']))) $item .= '*'.$this->content_targets['inlinepostend']['item_mobile'];
