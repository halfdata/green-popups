...
class lepopup_admin_class {
	...
	function __construct() {
		...
		if (is_admin()) {
			...
			if (($version && (!preg_match('/^\d+\.\d+\.\d+$/', $version) || version_compare($version, LEPOPUP_VERSION, '<'))) || $webfonts_version < LEPOPUP_WEBFONTS_VERSION) {
	...
	function admin_enqueue_scripts() {
		...
		wp_enqueue_style('lepopup-common', $lepopup->plugins_url.'/css/admin-common.css', array(), LEPOPUP_VERSION);
...
<script>
	...
	function admin_settings() {
		...
		if (isset($_GET['subpage']) && $_GET['subpage'] == 'integrations-log' && $lepopup->advanced_options['integrations-log'] == 'on') {
			$this->admin_integrations_log();
			return;
		}
		$custom_fonts = array();
...
<div class="wrap lepopup-admin lepopup">
	...
	<div class="lepopup-tabs lepopup-tabs-main">
		...
		'.($lepopup->advanced_options['integrations-log'] == 'on' ? '<a class="lepopup-tab" href="'.admin_url('admin.php').'?page=lepopup-settings&subpage=integrations-log">'.esc_html__('API Integrations Log', 'lepopup').'</a>' : '').'
	</div>
	<form class="lepopup-settings-form" enctype="multipart/form-data" method="post" style="margin: 0px" action="'.admin_url('admin.php').'">
		...
		echo '
				...
				<tr>
					<th>'.esc_html__('Google Fonts', 'lepopup').':</th>
					<td>
						<input type="checkbox" id="lepopup-googlefonts-enable" name="lepopup-googlefonts-enable" value="on" '.($lepopup->options['googlefonts-enable'] == "on" ? 'checked="checked"' : '').' /><label for="lepopup-googlefonts-enable"></label><span>'.esc_html__('Enable Google Fonts', 'lepopup').'</span>
						<br /><em>'.esc_html__('Turn this feature on if you want to use full set of Google FOnts loaded from Google servers.', 'lepopup').'</em>
					</td>
				</tr>
				<tr>
	...
	<form class="lepopup-settings-form" enctype="multipart/form-data" method="post" style="margin: 0px" action="'.admin_url('admin.php').'">
		...
		echo '
				...
				<tr>
					<th></th>
					<td>
						<input '.($is_curl ? '' : 'disabled="disabled" ').'type="checkbox" id="lepopup-advanced-enable-beehiiv" name="lepopup-advanced-enable-beehiiv" value="on" '.($lepopup->advanced_options['enable-beehiiv'] == "on" ? 'checked="checked"' : '').' /><label for="lepopup-advanced-enable-beehiiv"></label><span>'.esc_html__('Activate Beehiiv Integration module', 'lepopup').'</span>
						<br /><em>'.esc_html__('Turn this module on if you want to submit popup data to Beehiiv. Configure integration on popup editor.', 'lepopup').'</em>
					</td>
				</tr>
				<tr>
					<th></th>
				...
				<tr>
					<th></th>
					<td>
						<input '.($is_curl ? '' : 'disabled="disabled" ').'type="checkbox" id="lepopup-advanced-enable-encharge" name="lepopup-advanced-enable-encharge" value="on" '.($lepopup->advanced_options['enable-encharge'] == "on" ? 'checked="checked"' : '').' /><label for="lepopup-advanced-enable-encharge"></label><span>'.esc_html__('Activate Encharge Integration module', 'lepopup').'</span>
		...
		echo '
				...
				<tr>
					<th></th>
					<td>
						<input '.($is_curl ? '' : 'disabled="disabled" ').'type="checkbox" id="lepopup-advanced-enable-interspire" name="lepopup-advanced-enable-interspire" value="on" '.($lepopup->advanced_options['enable-interspire'] == "on" ? 'checked="checked"' : '').' /><label for="lepopup-advanced-enable-interspire"></label><span>'.esc_html__('Activate Interspire Integration module', 'lepopup').'</span>
		...
		echo '
				...
				<tr>
					<th></th>
					<td>
						<input '.($is_curl ? '' : 'disabled="disabled" ').'type="checkbox" id="lepopup-advanced-enable-mailmodo" name="lepopup-advanced-enable-mailmodo" value="on" '.($lepopup->advanced_options['enable-mailmodo'] == "on" ? 'checked="checked"' : '').' /><label for="lepopup-advanced-enable-mailmodo"></label><span>'.esc_html__('Activate Mailmodo Integration module', 'lepopup').'</span>
		...
		echo '
				...
				<tr>
					<th></th>
					<td>
						<input '.($is_curl ? '' : 'disabled="disabled" ').'type="checkbox" id="lepopup-advanced-enable-mojsmscontact" name="lepopup-advanced-enable-mojsmscontact" value="on" '.($lepopup->advanced_options['enable-mojsmscontact'] == "on" ? 'checked="checked"' : '').' /><label for="lepopup-advanced-enable-mojsmscontact"></label><span>'.esc_html__('Activate MojSMS (Contact) Integration module', 'lepopup').'</span>
						<br /><em>'.esc_html__('Turn this module on if you want to submit popup data to MojSMS (Contact). Configure integration on popup editor.', 'lepopup').'</em>
					</td>
				</tr>
				<tr>
					<th></th>
				...
				<tr>
					<th></th>
					<td>
						<input '.($is_curl ? '' : 'disabled="disabled" ').'type="checkbox" id="lepopup-advanced-enable-pabbly" name="lepopup-advanced-enable-pabbly" value="on" '.($lepopup->advanced_options['enable-pabbly'] == "on" ? 'checked="checked"' : '').' /><label for="lepopup-advanced-enable-pabbly"></label><span>'.esc_html__('Activate Pabbly Integration module', 'lepopup').'</span>
						<br /><em>'.esc_html__('Turn this module on if you want to submit popup data to Pabbly. Configure integration on popup editor.', 'lepopup').'</em>
					</td>
				</tr>
				<tr>
					<th></th>
				...
				<tr>
					<th></th>
					<td>
						<input '.($is_curl ? '' : 'disabled="disabled" ').'type="checkbox" id="lepopup-advanced-enable-sender" name="lepopup-advanced-enable-sender" value="on" '.($lepopup->advanced_options['enable-sender'] == "on" ? 'checked="checked"' : '').' /><label for="lepopup-advanced-enable-sender"></label><span>'.esc_html__('Activate Sender Integration module', 'lepopup').'</span>
						<br /><em>'.esc_html__('Turn this module on if you want to submit popup data to Sender. Configure integration on popup editor.', 'lepopup').'</em>
					</td>
				</tr>
				<tr>
					<th></th>
		...
		echo '
				...
				<tr>
					<th></th>
					<td>
						<input '.($is_curl ? '' : 'disabled="disabled" ').'type="checkbox" id="lepopup-advanced-enable-mojsms" name="lepopup-advanced-enable-mojsms" value="on" '.($lepopup->advanced_options['enable-mojsms'] == "on" ? 'checked="checked"' : '').' /><label for="lepopup-advanced-enable-mojsms"></label><span>'.esc_html__('Activate MojSMS (SMS) Integration module', 'lepopup').'</span>
						<br /><em>'.esc_html__('Turn this module on if you want to use MojSMS (SMS) gateway. Configure integration on popup editor.', 'lepopup').'</em>
					</td>
				</tr>
				<tr>
					<th></th>
		...
		echo '
			...
			<table class="lepopup-useroptions">
				...
				<tr>
					<th></th>
					<td>
						<input '.($is_curl ? '' : 'disabled="disabled" ').'type="checkbox" id="lepopup-advanced-enable-reoonemailverifier" name="lepopup-advanced-enable-reoonemailverifier" value="on" '.($lepopup->advanced_options['enable-reoonemailverifier'] == "on" ? 'checked="checked"' : '').' /><label for="lepopup-advanced-enable-reoonemailverifier"></label><span>'.esc_html__('Activate Reoon Email Verifier Integration module', 'lepopup').'</span>
						<br /><em>'.sprintf(esc_html__('Turn this module on if you want to use %sReoon Email Verifier%s to validate email addresses. Configure integration on General Settings page.', 'lepopup'), '<a href="https://emailverifier.reoon.com/" target="_blank">', '</a>').'</em>
					</td>
				</tr>
				<tr>
					<th></th>
			...
			<table class="lepopup-useroptions">
				...
				<tr>
					<th>'.esc_html__('API Integrations Log', 'lepopup').':</th>
					<td>
						<input type="checkbox" id="lepopup-advanced-integrations-log" name="lepopup-advanced-integrations-log" '.($lepopup->advanced_options['integrations-log'] == "on" ? 'checked="checked"' : '').'"><label for="lepopup-advanced-integrations-log"></label><span>'.esc_html__('Enable API integrations log page', 'lepopup').'</span><span class="lepopup-badge lepopup-badge-info">Beta</span>
...
<div id="lepopup-global-message"></div>';
	...
	function admin_integrations_log() {
		global $wpdb, $lepopup;

		if (isset($_GET["s"])) $search_query = trim(stripslashes($_GET["s"]));
		else $search_query = "";
		
		if (isset($_GET["provider"])) $provider = stripslashes($_GET["provider"]);
		else $provider = '';
		$providers = $wpdb->get_results("SELECT DISTINCT provider FROM ".$wpdb->prefix."lepopup_integrations_log WHERE deleted = '0' ORDER BY provider ASC", ARRAY_A);

		$filter = '';
		if (!empty($provider)) $filter = " AND provider = '".esc_sql($provider)."'";
		if (!empty($search_query)) $filter .= " AND (url LIKE '%".esc_sql($wpdb->esc_like($search_query))."%' OR request_content LIKE '%".esc_sql($wpdb->esc_like($search_query))."%' OR response_content LIKE '%".esc_sql($wpdb->esc_like($search_query))."%')";
		
		$tmp = $wpdb->get_row("SELECT COUNT(*) AS total FROM ".$wpdb->prefix."lepopup_integrations_log WHERE deleted = '0'".$filter, ARRAY_A);
		$total = $tmp["total"];
		...
		$switcher = $lepopup->page_switcher(admin_url('admin.php').'?page=lepopup-settings&subpage=integrations-log'.(!empty($provider) ? '&provider='.rawurlencode($provider) : '').((strlen($search_query) > 0) ? '&s='.rawurlencode($search_query) : ''), $page, $totalpages);
		
		$sql = "SELECT * FROM ".$wpdb->prefix."lepopup_integrations_log WHERE deleted = '0'".$filter." ORDER BY id DESC LIMIT ".esc_sql(($page-1)*LEPOPUP_RECORDS_PER_PAGE).", ".esc_sql(LEPOPUP_RECORDS_PER_PAGE);
		$rows = $wpdb->get_results($sql, ARRAY_A);
...
<div class="wrap lepopup-admin">
	...
	<div class="lepopup-tabs lepopup-tabs-main">
		<a class="lepopup-tab" href="'.admin_url('admin.php').'?page=lepopup-settings">'.esc_html__('General', 'lepopup').'</a>
		<a class="lepopup-tab" href="'.admin_url('admin.php').'?page=lepopup-settings&subpage=advanced">'.esc_html__('Advanced', 'lepopup').'</a>
		<a class="lepopup-tab lepopup-tab-active" href="'.admin_url('admin.php').'?page=lepopup-settings&subpage=integrations-log">'.esc_html__('API Integrations Log', 'lepopup').'</a>
	</div>
	<div class="lepopup-top-forms" style="margin-top: 2em;">
		<div class="lepopup-top-form-left">
			<form action="'.admin_url('admin.php').'" method="get"  class="uap-filter-form lepopup-filter-form">
			<input type="hidden" name="page" value="lepopup-settings" />
			<input type="hidden" name="subpage" value="integrations-log" />
			'.($provider > 0 ? '<input type="hidden" name="provider" value="'.esc_html($provider).'" />' : '').'
			...
			'.((strlen($search_query) > 0) ? '<input type="button" class="lepopup-button-search" value="'.esc_html__('Reset search results', 'lepopup').'" onclick="window.location.href=\''.admin_url('admin.php').'?page=lepopup-settings&subpage=integrations-log'.(!empty($provider) > 0 ? '&provider='.rawurlencode($provider) : '').'\';" />' : '').'
			</form>
		</div>
		<div class="lepopup-top-form-right">
			...
			<select name="provider" class="form-control" style="width: 150px;" onchange="jQuery(\'#lepopup-filter-form\').submit();">
				<option value="">'.esc_html__('All Providers', 'lepopup').'</option>';
			foreach ($providers as $p) {
				echo '
				<option value="'.esc_html($p['provider']).'"'.($p['provider'] == $provider ? ' selected="selected"' : '').'>'.esc_html($p['provider']).'</option>';
			}
			echo '
			</select>
			</form>
	...
	<table id="lepopup-table-log" class="lepopup-table-list widefat">
		<tr>
			...
			<th style="width: 70px;">'.esc_html__('Response', 'lepopup').'</th>
		...
		if (sizeof($rows) > 0) {
			foreach ($rows as $row) {
				...
				<tr>
					...
					<td class="lepopup-column">'.esc_html($row['provider']).'</td>
					<td class="lepopup-table-list-column-shortcode"><input type="text" value="'.esc_html($row['url']).'" readonly="readonly" style="" onclick="this.focus();this.select();"></td>
					<td class="lepopup-column">'.esc_html($row['method']).'</td>
					<td class="lepopup-column">'.esc_html($row['response_status_code']).'</td>
					...
					<td class="lepopup-column lepopup-column-actions">
						<div class="lepopup-table-list-actions">
							...
							<div class="lepopup-table-list-menu">
								<ul>
									<li><a href="#" onclick="return lepopup_integrations_log_details_open(this);" data-id="'.esc_html($row['id']).'">'.esc_html__('Details', 'lepopup').'</a></li>
									<li><a href="#" data-id="'.esc_html($row['id']).'" data-doing="'.esc_html__('Deleting...', 'lepopup').'" onclick="return lepopup_integrations_log_delete(this);">'.esc_html__('Delete', 'lepopup').'</a></li>
								</ul>
							</div>
						</div>
					</td>
	...
	<div class="lepopup-table-list-buttons">
		<a href="#" class="lepopup-button lepopup-button-small" onclick="return lepopup_bulk_integrations_log_delete(this);"><i class="fas fa-trash"></i><label>'.esc_html__('Delete Selected', 'lepopup').'</label></a>
	</div>
</div>
<div id="lepopup-global-message"></div>';
...
<div class="lepopup-admin-popup" id="lepopup-record-details">
	<div class="lepopup-admin-popup-inner">
		<div class="lepopup-admin-popup-title">
			...
			<h3><i class="fas fa-cog"></i> '.esc_html__('API Request Details', 'lepopup').'<span></span></h3>
		</div>
...
<div class="lepopup-admin-create-overlay">
	<div class="lepopup-admin-create">
		...
		echo $this->admin_dialog_html();
		$webfonts = array();
		if ($lepopup->options['googlefonts-enable'] == 'on') {
