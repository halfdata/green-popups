<?php
/* MailerLite Classic integration for Green Popups */
if (!defined('UAP_CORE') && !defined('ABSPATH')) exit;
class lepopup_mailerliteclassic_class {
	...
	function __construct() {
		if (is_admin()) {
			...
			add_action('wp_ajax_lepopup-mailerliteclassic-settings-html', array(&$this, "admin_settings_html"));
			add_action('wp_ajax_lepopup-mailerliteclassic-list', array(&$this, "admin_lists"));
			add_action('wp_ajax_lepopup-mailerliteclassic-fields', array(&$this, "admin_fields_html"));
		}
		add_filter('lepopup_integrations_do_mailerliteclassic', array(&$this, 'front_submit'), 10, 2);
	}
	
	function providers($_providers) {
		if (!array_key_exists("mailerliteclassic", $_providers)) $_providers["mailerliteclassic"] = esc_html__('MailerLite Classic', 'lepopup');
		return $_providers;
	}
		...
		if (current_user_can('manage_options')) {
			...
			<div class="lepopup-properties-item">
				...
				<div class="lepopup-properties-content">
					...
					<label class="lepopup-integrations-description">'.sprintf(esc_html__('Find MailerLite API Key on %sDeveloper API%s page.', 'lepopup'), '<a href="https://app.mailerliteclassic.com/integrations/api/" target="_blank">', '</a>').'</label>
				</div>
			</div>
			<div class="lepopup-properties-item">
				<div class="lepopup-properties-label">
...
$lepopup_mailerliteclassic = new lepopup_mailerliteclassic_class();
?>