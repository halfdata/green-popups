...
class lepopup_mailerlite_class {
		...
		if (current_user_can('manage_options')) {
			...
			<div class="lepopup-properties-item">
				...
				<div class="lepopup-properties-tooltip">
					...
					<div class="lepopup-tooltip-content">'.esc_html__('Enter your MailerLite Token Key.', 'lepopup').'</div>
				</div>
				<div class="lepopup-properties-content">
					<input type="text" name="api-key" value="'.esc_html($data['api-key']).'" />
					<label class="lepopup-integrations-description">'.sprintf(esc_html__('Find MailerLite API Token on %sDeveloper API%s page.', 'lepopup'), '<a href="https://dashboard.mailerlite.com/integrations/api" target="_blank">', '</a>').'</label>
				</div>
			</div>
			<div class="lepopup-properties-item">
				<div class="lepopup-properties-label">
		...
		if (!empty($result) && is_array($result)) {
			...
			<table>';
				foreach ($result['data'] as $field) {
					if (is_array($field)) {
						if (array_key_exists('key', $field) && array_key_exists('name', $field)) {
				...
				<tr>
					...
					<td>
						...
						<label class="lepopup-integrations-description">'.esc_html($field['name'].' ('.$field['key'].')').'</label>
					</td>
				</tr>';
						}
					}
	...
	function connect($_api_key, $_path, $_data = array(), $_method = '') {
		...
		try {
			$url = 'https://connect.mailerlite.com/api/'.ltrim($_path, '/');
			$curl = curl_init($url);
