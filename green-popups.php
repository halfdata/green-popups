...
class lepopup_class {
	...
	var $logic_rules = array();
	var $confirmations_meta = array();
	var $notifications_meta = array();
	var $math_meta = array();
	var $integrations_meta = array();
	var $payment_gateways_meta = array();
		...
		$this->element_properties_meta = array(
			'settings' => array(
				'general-tab' => array('type' => 'tab', 'value' => 'general', 'label' => esc_html__('General', 'lepopup')),
					...
					'datetime-args' => array('value' => array('date-format' => 'yyyy-mm-dd', 'time-format' => 'hh:ii', 'locale' => 'en'), 'label' => esc_html__('Date and time parameters', 'lepopup'), 'tooltip' => esc_html__('Choose the date and time formats and language for datetimepicker. It is used for "date" and "time" fields.', 'lepopup'), 'type' => 'datetime-args', 'date-format-options' => array('yyyy-mm-dd' => 'YYYY-MM-DD', 'mm/dd/yyyy' => 'MM/DD/YYYY', 'dd/mm/yyyy' => 'DD/MM/YYYY', 'dd.mm.yyyy' => 'DD.MM.YYYY'), 'date-format-label' => esc_html__('Date format', 'lepopup'), 'time-format-options' => array('hh:ii aa' => '12 hours', 'hh:ii' => '24 hours'), 'time-format-label' => esc_html__('Time format', 'lepopup'), 'locale-options' => array('en', 'cs', 'da', 'de', 'es', 'fi', 'fr', 'hu', 'it', 'nl', 'pl', 'pt', 'ro', 'ru', 'sk', 'tr', 'zh'), 'locale-label' => esc_html__('Language', 'lepopup')),
				...
				'confirmation-tab' => array('type' => 'tab', 'value' => 'confirmation', 'label' => esc_html__('Confirmations', 'lepopup')),
					'confirmations' => array('type' => 'confirmations', 'values' => array(), 'label' => esc_html__('Confirmations', 'lepopup'), 'message' => esc_html__('By default after successfull form submission the popup is closed. You can customize confirmation and use conditional logic. If several confirmations match the same conditions, the first one (higher priority) will be applied. Sort confirmations (drag and drop) to set priority.', 'lepopup')),
				...
				'advanced-tab' => array('type' => 'tab', 'value' => 'advanced', 'label' => esc_html__('Advanced', 'lepopup')),
					...
					'start-misc' => array('type' => 'section-start', 'section' => 'misc'),
						...
						'misc-disable-html-scrollbar' => array('value' => 'off', 'label' => esc_html__('Disable page scrollbar', 'lepopup'), 'tooltip' => esc_html__('Disable page scrollbar when popup is visible.', 'lepopup'), 'type' => 'checkbox'),
						...
						'hr-11' => array('type' => 'hr'),
						'antibot-enable' => array('value' => 'on', 'label' => esc_html__('Antibot protection', 'lepopup'), 'tooltip' => esc_html__('Enable protection against of repeated submissions.', 'lepopup'), 'type' => 'checkbox'),
						'antibot-delay' => array('value' => '10', 'label' => esc_html__('Repeated submission delay', 'lepopup'), 'tooltip' => esc_html__('Specify the delay (seconds) when the same user can submit data through the form.', 'lepopup'), 'unit' => 'seconds', 'type' => 'units', 'visible' => array('antibot-enable' => array('on'))),
						'antibot-check-form' => array('value' => 'on', 'label' => esc_html__('Check form data', 'lepopup'), 'tooltip' => esc_html__('Enable this feature to prohibit submission of the same data through the form.', 'lepopup'), 'type' => 'checkbox', 'visible' => array('antibot-enable' => array('on'))),
						'antibot-check-ip' => array('value' => 'on', 'label' => esc_html__('Check IP-address', 'lepopup'), 'tooltip' => esc_html__('Enable this feature to prohibit submission from the same IP-address.', 'lepopup'), 'type' => 'checkbox', 'visible' => array('antibot-enable' => array('on'))),
						'antibot-error' => array('value' => esc_html__('Thank you. We have already got your request.', 'lepopup'), 'label' => esc_html__('Error message', 'lepopup'), 'type' => 'error', 'visible' => array('antibot-enable' => array('on'))),
			...
			'select' => array(
				'basic' => array('type' => 'tab', 'value' => 'basic', 'label' => esc_html__('Basic', 'lepopup')),
					...
					'position' => array('value' => array('top' => '0', 'left' => '0'), 'caption' => array('top' => esc_html__('Top', 'lepopup'), 'left' => esc_html__('Left', 'lepopup')), 'label' => esc_html__('Position', 'lepopup'), 'tooltip' => esc_html__('Set the position of the element relative to the upper left corner of the base frame.', 'lepopup'), 'type' => 'top-left'),
					'size' => array('value' => array('width' => '360', 'height' => '40'), 'caption' => array('width' => esc_html__('Width', 'lepopup'), 'height' => esc_html__('Height', 'lepopup')), 'label' => esc_html__('Size', 'lepopup'), 'tooltip' => esc_html__('Set the size of the element.', 'lepopup'), 'type' => 'width-height'),
					'submit-on-select' => array('value' => 'off', 'label' => esc_html__('Submit on select', 'lepopup'), 'tooltip' => esc_html__('If enabled, the form is submitted when user do selection.', 'lepopup'), 'caption' => esc_html__('Submit on select', 'lepopup'), 'type' => 'checkbox'),
			...
			'imageselect' => array(
				'basic' => array('type' => 'tab', 'value' => 'basic', 'label' => esc_html__('Basic', 'lepopup')),
					...
					'submit-on-select' => array('value' => 'off', 'label' => esc_html__('Submit on select', 'lepopup'), 'tooltip' => esc_html__('If enabled, the form is submitted when user do selection.', 'lepopup'), 'caption' => esc_html__('Submit on select', 'lepopup'), 'type' => 'checkbox', 'visible' => array('mode' => array('radio'))),
...
//					'default' => array('value' => '', 'label' => esc_html__('Default value', 'lepopup'), 'tooltip' => esc_html__('The default value is the value that the field has before the user has entered anything.', 'lepopup'), 'type' => 'date'),
		...
		if (file_exists(dirname(__FILE__).'/modules/beehiiv.php') && $this->advanced_options['enable-beehiiv'] == 'on') include_once(dirname(__FILE__).'/modules/beehiiv.php');
		...
		if (file_exists(dirname(__FILE__).'/modules/mailerlite-classic.php') && $this->advanced_options['enable-mailerlite'] == 'on') include_once(dirname(__FILE__).'/modules/mailerlite-classic.php');
		...
		if (file_exists(dirname(__FILE__).'/modules/mojsms-contact.php') && $this->advanced_options['enable-mojsmscontact'] == 'on') include_once(dirname(__FILE__).'/modules/mojsms-contact.php');
		...
		if (file_exists(dirname(__FILE__).'/modules/pabbly.php') && $this->advanced_options['enable-pabbly'] == 'on') include_once(dirname(__FILE__).'/modules/pabbly.php');
		...
		if (file_exists(dirname(__FILE__).'/modules/sender.php') && $this->advanced_options['enable-sender'] == 'on') include_once(dirname(__FILE__).'/modules/sender.php');
		...
		if (file_exists(dirname(__FILE__).'/modules/reoonemailverifier.php') && $this->advanced_options['enable-reoonemailverifier'] == 'on') include_once(dirname(__FILE__).'/modules/reoonemailverifier.php');
	...
	static function activate() {
		...
		if ($wpdb->get_var("SHOW COLUMNS FROM ".$wpdb->prefix."lepopup_records LIKE 'hash'") != 'hash') {
			$sql = "ALTER TABLE ".$wpdb->prefix."lepopup_records ADD hash varchar(63) collate latin1_general_cs NULL default ''";
			$wpdb->query($sql);
		}
		...
		$table_name = $wpdb->prefix."lepopup_integrations_log";
		if($wpdb->get_var("SHOW TABLES LIKE '".esc_sql($table_name)."'") != $table_name) {
			$sql = "CREATE TABLE ".esc_sql($table_name)." (
				id int(11) NOT NULL auto_increment,
				provider varchar(63) collate latin1_general_cs NULL,
				url varchar(255) collate latin1_general_cs NULL,
				method varchar(15) collate latin1_general_cs NULL,
				request_headers longtext collate utf8_unicode_ci NULL,
				request_content_type varchar(15) collate latin1_general_cs NULL,
				request_content longtext collate utf8_unicode_ci NULL,
				response_status_code int(11) NULL,
				response_headers longtext collate utf8_unicode_ci NULL,
				response_content_type varchar(15) collate latin1_general_cs NULL,
				response_content longtext collate utf8_unicode_ci NULL,
				created int(11) NULL,
				deleted int(11) NULL default '0',
				UNIQUE KEY  id (id)
			);";
	...
	function add_integrations_log_record($_data) {
		global $wpdb;
		$wpdb->query("INSERT INTO ".$wpdb->prefix."lepopup_integrations_log (
			provider,
			url,
			method,
			request_headers,
			...
			'".esc_sql($_data['provider'])."',
			'".esc_sql($_data['url'])."',
			'".esc_sql($_data['method'])."',
			'".esc_sql($_data['request_headers'])."',
			'".esc_sql($_data['request_content_type'])."',
			'".esc_sql($_data['request_content'])."',
			'".esc_sql($_data['response_status_code'])."',
			'".esc_sql($_data['response_headers'])."',
			'".esc_sql($_data['response_content_type'])."',
			'".esc_sql($_data['response_content'])."',
			'".esc_sql(time())."','0')");
	}
